...
for text, pattern in texts:
    results.append({
        "Text": "Custom Text File",
        "Pattern": pattern,
        "KMP": measure_search_time(kmp_search, text, pattern),
        "Boyer-Moore": measure_search_time(boyer_moore_search, text, pattern),
        "Rabin-Karp": measure_search_time(rabin_karp_search, text, pattern)
    })
